...
enum {
        ...
        MEDUSA_WEBSOCKETCLIENT_EVENT_RESOLVING                  = (1 <<  1),
        MEDUSA_WEBSOCKETCLIENT_EVENT_RESOLVE_TIMEOUT            = (1 <<  2),
        MEDUSA_WEBSOCKETCLIENT_EVENT_RESOLVED                   = (1 <<  3),
        MEDUSA_WEBSOCKETCLIENT_EVENT_CONNECTING                 = (1 <<  4),
        MEDUSA_WEBSOCKETCLIENT_EVENT_CONNECT_TIMEOUT            = (1 <<  5),
        MEDUSA_WEBSOCKETCLIENT_EVENT_CONNECTED                  = (1 <<  6),
        MEDUSA_WEBSOCKETCLIENT_EVENT_SENDING_REQUEST            = (1 <<  7),
        MEDUSA_WEBSOCKETCLIENT_EVENT_REQUEST_SENT               = (1 <<  8),
        MEDUSA_WEBSOCKETCLIENT_EVENT_RECEIVING_RESPONSE         = (1 <<  9),
        MEDUSA_WEBSOCKETCLIENT_EVENT_RESPONSE_HEADER            = (1 << 10),
        MEDUSA_WEBSOCKETCLIENT_EVENT_RESPONSE_RECEIVED          = (1 << 11),
        MEDUSA_WEBSOCKETCLIENT_EVENT_MESSAGE                    = (1 << 12),
        MEDUSA_WEBSOCKETCLIENT_EVENT_BUFFERED_WRITE             = (1 << 13),
        MEDUSA_WEBSOCKETCLIENT_EVENT_BUFFERED_WRITE_FINISHED    = (1 << 14),
        MEDUSA_WEBSOCKETCLIENT_EVENT_DISCONNECTED               = (1 << 15),
        MEDUSA_WEBSOCKETCLIENT_EVENT_STATE_CHANGED              = (1 << 16),
        MEDUSA_WEBSOCKETCLIENT_EVENT_DESTROY                    = (1 << 17)
#define MEDUSA_WEBSOCKETCLIENT_EVENT_ERROR                      MEDUSA_WEBSOCKETCLIENT_EVENT_ERROR
#define MEDUSA_WEBSOCKETCLIENT_EVENT_RESOLVING                  MEDUSA_WEBSOCKETCLIENT_EVENT_RESOLVING
#define MEDUSA_WEBSOCKETCLIENT_EVENT_RESOLVE_TIMEOUT            MEDUSA_WEBSOCKETCLIENT_EVENT_RESOLVE_TIMEOUT
#define MEDUSA_WEBSOCKETCLIENT_EVENT_RESOLVED                   MEDUSA_WEBSOCKETCLIENT_EVENT_RESOLVED
#define MEDUSA_WEBSOCKETCLIENT_EVENT_CONNECTING                 MEDUSA_WEBSOCKETCLIENT_EVENT_CONNECTING
#define MEDUSA_WEBSOCKETCLIENT_EVENT_CONNECT_TIMEOUT            MEDUSA_WEBSOCKETCLIENT_EVENT_CONNECT_TIMEOUT
...
#define MEDUSA_WEBSOCKETCLIENT_EVENT_STATE_CHANGED              MEDUSA_WEBSOCKETCLIENT_EVENT_STATE_CHANGED
...
enum {
        ...
        MEDUSA_WEBSOCKETCLIENT_STATE_RESOLVING          =  2,
        MEDUSA_WEBSOCKETCLIENT_STATE_RESOLVED           =  3,
        MEDUSA_WEBSOCKETCLIENT_STATE_CONNECTING         =  4,
        MEDUSA_WEBSOCKETCLIENT_STATE_SENDING_REQUEST    =  5,
        MEDUSA_WEBSOCKETCLIENT_STATE_REQUEST_SENT       =  6,
        MEDUSA_WEBSOCKETCLIENT_STATE_RECEIVING_RESPONSE =  7,
        MEDUSA_WEBSOCKETCLIENT_STATE_RESPONSE_RECEIVED  =  8,
        MEDUSA_WEBSOCKETCLIENT_STATE_CONNECTED          =  9,
        MEDUSA_WEBSOCKETCLIENT_STATE_ERROR              = 10
...
#define MEDUSA_WEBSOCKETCLIENT_STATE_RESOLVING          MEDUSA_WEBSOCKETCLIENT_STATE_RESOLVING
#define MEDUSA_WEBSOCKETCLIENT_STATE_RESOLVED           MEDUSA_WEBSOCKETCLIENT_STATE_RESOLVED
#define MEDUSA_WEBSOCKETCLIENT_STATE_CONNECTING         MEDUSA_WEBSOCKETCLIENT_STATE_CONNECTING
...
enum {
        MEDUSA_WEBSOCKETCLIENT_ERROR_REASON_INTERNAL    = 0,
        MEDUSA_WEBSOCKETCLIENT_ERROR_REASON_PARSER      = 1,
        MEDUSA_WEBSOCKETCLIENT_ERROR_REASON_TCPSOCKET   = 2
#define MEDUSA_WEBSOCKETCLIENT_ERROR_REASON_INTERNAL    MEDUSA_WEBSOCKETCLIENT_ERROR_REASON_INTERNAL
