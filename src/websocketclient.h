...
enum {
        ...
        MEDUSA_WEBSOCKETCLIENT_EVENT_RESOLVED                   = (1 <<  2),
        MEDUSA_WEBSOCKETCLIENT_EVENT_CONNECTING                 = (1 <<  3),
        MEDUSA_WEBSOCKETCLIENT_EVENT_CONNECTED                  = (1 <<  4),
        MEDUSA_WEBSOCKETCLIENT_EVENT_SENDING_REQUEST            = (1 <<  5),
        MEDUSA_WEBSOCKETCLIENT_EVENT_REQUEST_SENT               = (1 <<  6),
        MEDUSA_WEBSOCKETCLIENT_EVENT_RECEIVING_RESPONSE         = (1 <<  7),
        MEDUSA_WEBSOCKETCLIENT_EVENT_RESPONSE_HEADER            = (1 <<  8),
        MEDUSA_WEBSOCKETCLIENT_EVENT_RESPONSE_RECEIVED          = (1 <<  9),
        MEDUSA_WEBSOCKETCLIENT_EVENT_MESSAGE                    = (1 << 10),
        MEDUSA_WEBSOCKETCLIENT_EVENT_BUFFERED_WRITE             = (1 << 11),
        MEDUSA_WEBSOCKETCLIENT_EVENT_BUFFERED_WRITE_FINISHED    = (1 << 12),
        MEDUSA_WEBSOCKETCLIENT_EVENT_DISCONNECTED               = (1 << 13),
        MEDUSA_WEBSOCKETCLIENT_EVENT_STATE_CHANGED              = (1 << 14),
        MEDUSA_WEBSOCKETCLIENT_EVENT_DESTROY                    = (1 << 15)
