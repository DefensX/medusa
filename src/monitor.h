...
enum {
        MEDUSA_MONITOR_POLL_DEFAULT     = 0,
        MEDUSA_MONITOR_POLL_EPOLL       = 1,
        MEDUSA_MONITOR_POLL_KQUEUE      = 2,
        MEDUSA_MONITOR_POLL_POLL        = 3,
        MEDUSA_MONITOR_POLL_SELECT      = 4,
        MEDUSA_MONITOR_POLL_WSAPOLL     = 5
...
#define MEDUSA_MONITOR_POLL_WSAPOLL     MEDUSA_MONITOR_POLL_WSAPOLL
};

enum {
        MEDUSA_MONITOR_TIMER_DEFAULT    = 0,
        MEDUSA_MONITOR_TIMER_TIMERFD    = 1,
        MEDUSA_MONITOR_TIMER_MONOTONIC  = 2
...
enum {
        MEDUSA_MONITOR_SIGNAL_DEFAULT   = 0,
        MEDUSA_MONITOR_SIGNAL_SIGACTION = 1,
        MEDUSA_MONITOR_SIGNAL_NULL      = 2
...
enum {
        ...
        MEDUSA_MONITOR_FLAG_THREAD_SAFE = (1 << 0), /* 0x00000001 */
